...
def keyboard_help_text():
    ...
    return (
        ...
        'Alt+G — Seguir ou deixar de seguir quando a rede oferece o controle; '
        'no TikTok, deixar de seguir pode exigir usar F6 e abrir o perfil diretamente na página\n'
